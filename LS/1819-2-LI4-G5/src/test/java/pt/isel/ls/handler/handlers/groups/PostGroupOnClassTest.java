...
public class PostGroupOnClassTest extends PostHandlersTest {

    @Override
    protected String getValidReference() {
        return "Post succeeded, Group Number created = 2";
    }

    @Override
    protected CommandHandler getHandler() {
        return new PostGroupOnClass(new TestTransactionManager<>(ds));
    }
